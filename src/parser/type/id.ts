/**
 * Base value types supported by parser option schemas. Each option's `type`
...
/**
 * All valid `ParserTypeId` values. Used for schema validation and to build
 * detailed error messages listing the accepted type ids.
 *
 * @category Parser
 */
export const parserTypeIds: readonly ParserTypeId[] = [
	'boolean',
	'string',
	'number',
	'posInt',
